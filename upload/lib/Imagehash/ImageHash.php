...
class ImageHash
{
     ...
     * @param string $mode
     */
    public function __construct(Implementation $implementation = null, $mode = self::HEXADECIMAL) // todo alway must return hex
    {
     ...
     * @return int
     */
    public function hash($resource, $destroy = false)
    {
